...
int parallel_write(char*,long,long long,void*);
int parallel_read(char*,long,long long,void*);
#if defined ADD0US
void f77_parallel_read(char*,int*,long*,long long*,void*);
void f77_parallel_write(char*,int*,long*,long long*,void*);
#elif defined ADD2US
void f77_parallel_read__(char*,int*,long*,long long*,void*);
void f77_parallel_write__(char*,int*,long*,long long*,void*);
#else
void f77_parallel_read_(char*,int*,long*,long long*,void*);
void f77_parallel_write_(char*,int*,long*,long long*,void*);
#endif
// This routine writes size bytes of buffer at position offset
// in the file filename.
// Can be used in multiple concurrent access

int parallel_write(char *filename, long size, long long offset, void *buffer) {
  ...
  stat=pwrite64(fd,buffer,size,offset);
  close(fd);
...
int parallel_read(char *filename, long size, long long offset, void *buffer) {
  ...
  stat = pread64(fd,buffer,size,offset);
  close(fd);
  if (stat != size) return(1);
  else return(0);
}
